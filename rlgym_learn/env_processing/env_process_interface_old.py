...
class EnvProcessInterface(
    ...
    def __init__(
        ...
        self.current_timestep_id_map: List[Dict[AgentID, int]] = []
    ...
    def _collect_responses(
        ...
        List[Timestep], List[Tuple[int, Dict[AgentID, ObsType]]], List[StateMetrics]
    ]:
        """
    ...
    def _collect_response(
        ...
        for agent_id in agent_ids:
            ...
            self.timestep_id += 1
            self.current_timestep_id_map[proc_id][agent_id] = self.timestep_id
            timesteps.append(
                Timestep(
